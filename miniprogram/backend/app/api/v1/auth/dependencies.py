...
from app.api.v1.auth.service import WechatAuthService, PhoneAuthService
from app.core.dependencies import get_db
from app.api.v1.auth.schemas import AuthSchema
from app.core.exception import UnauthorizedException
from app.core.security import decode_token

# OAuth2 密码流（用于获取令牌）
oauth2_scheme = OAuth2PasswordBearer(
    tokenUrl="/api/v1/auth/wechat/login", auto_error=False
)
