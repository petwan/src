...
```python
from app.api.v1.auth.dependencies import CurrentUserOptional
...
```python
from app.api.v1.auth.dependencies import CurrentActiveUser
...
```python
from app.api.v1.auth.dependencies import WechatAuth
